...
Module Memory
    ...
    Public ServerPort As Integer = 15243
    Sub LoadMemory()
        Try
            Dim llaveReg As String = "SOFTWARE\\Zhenboro\\RMTCAM"
    ...
    Sub SaveMemory()
        Try
            ...
            If registerKey Is Nothing Then
                ...
                ServerIP = InputBox("Ingrese la direccion IP", "Valores", ServerIP)
                ServerPort = InputBox("Ingrese el puerto", "Valores", ServerPort)
            End If
